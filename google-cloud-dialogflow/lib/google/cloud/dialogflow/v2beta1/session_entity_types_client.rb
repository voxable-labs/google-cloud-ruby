  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        #   @return [Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes::Stub]
        class SessionEntityTypesClient
          ...
          def initialize \
            ...
            @session_entity_types_stub = Google::Gax::Grpc.create_stub(
              ...
              scopes: scopes,
              &Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes::Stub.method(:new)
            )
          ...
          #   retries, etc.
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::V2beta1::SessionEntityType>]
          #   An enumerable of Google::Cloud::Dialogflow::V2beta1::SessionEntityType instances.
          ...
          #
          #   session_entity_types_client = Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes.new
          #   formatted_parent = Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient.session_path("[PROJECT]", "[SESSION]")
          #
          ...
          def list_session_entity_types \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::ListSessionEntityTypesRequest)
          ...
          #
          #   session_entity_types_client = Google::Cloud::Dialogflow::V2beta1::SessionEntityTypes.new
          #   formatted_name = Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient.session_entity_type_path("[PROJECT]", "[SESSION]", "[ENTITY_TYPE]")
          ...
          def get_session_entity_type \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::GetSessionEntityTypeRequest)
          ...
          #   Note: Runtimes are under construction and will be available soon.
          #   If <Runtime ID> is not specified, we assume default 'sandbox' runtime.
          # @param session_entity_type [Google::Cloud::Dialogflow::V2beta1::SessionEntityType | Hash]
          #   Required. The session entity type to create.
          #   A hash of the same form as `Google::Cloud::Dialogflow::V2beta1::SessionEntityType`
          ...
          def create_session_entity_type \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::CreateSessionEntityTypeRequest)
          ...
          def update_session_entity_type \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::UpdateSessionEntityTypeRequest)
          ...
          def delete_session_entity_type \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::DeleteSessionEntityTypeRequest)
