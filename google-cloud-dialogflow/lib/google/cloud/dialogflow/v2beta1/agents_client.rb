...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/v2beta1/agent.proto,
  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        #
        # After you create an agent, you can add {Google::Cloud::Dialogflow::V2beta1::Intents Intents}, {Google::Cloud::Dialogflow::V2beta1::Contexts Contexts},
        # {Google::Cloud::Dialogflow::V2beta1::EntityTypes Entity Types}, {Google::Cloud::Dialogflow::V2beta1::WebhookRequest Webhooks}, and so on to
        ...
        # using the {Google::Cloud::Dialogflow::V2beta1::Agents::ExportAgent ExportAgent} method. You can import a saved
        # agent by using the {Google::Cloud::Dialogflow::V2beta1::Agents::ImportAgent ImportAgent} method.
        #
        ...
        #   @return [Google::Cloud::Dialogflow::V2beta1::Agents::Stub]
        class AgentsClient
          ...
          def initialize \
            ...
            @agents_stub = Google::Gax::Grpc.create_stub(
              ...
              scopes: scopes,
              &Google::Cloud::Dialogflow::V2beta1::Agents::Stub.method(:new)
            )
          ...
          #
          #   agents_client = Google::Cloud::Dialogflow::V2beta1::Agents.new
          ...
          def get_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::GetAgentRequest)
          ...
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::V2beta1::Agent>]
          #   An enumerable of Google::Cloud::Dialogflow::V2beta1::Agent instances.
          ...
          def search_agents \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::SearchAgentsRequest)
          ...
          def train_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::TrainAgentRequest)
          ...
          def export_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::ExportAgentRequest)
            operation = Google::Gax::Operation.new(
          ...
          def import_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::ImportAgentRequest)
            operation = Google::Gax::Operation.new(
          ...
          def restore_agent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::RestoreAgentRequest)
            operation = Google::Gax::Operation.new(
