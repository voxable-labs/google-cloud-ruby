...
# https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/v2beta1/session.proto,
  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        #   @return [Google::Cloud::Dialogflow::V2beta1::Sessions::Stub]
        class SessionsClient
          ...
          def initialize \
            ...
            @sessions_stub = Google::Gax::Grpc.create_stub(
              ...
              scopes: scopes,
              &Google::Cloud::Dialogflow::V2beta1::Sessions::Stub.method(:new)
            )
          ...
          #   A hash of the same form as `Google::Cloud::Dialogflow::V2beta1::QueryInput`
          ...
          #
          #   sessions_client = Google::Cloud::Dialogflow::V2beta1::Sessions.new
          ...
          def detect_intent \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::DetectIntentRequest)
          ...
          #
          # @param reqs [Enumerable<Google::Cloud::Dialogflow::V2beta1::StreamingDetectIntentRequest>]
          #   The input requests.
          # @param options [Google::Gax::CallOptions]
          #   Overrides the default settings for this call, e.g, timeout,
          #   retries, etc.
          # @return [Enumerable<Google::Cloud::Dialogflow::V2beta1::StreamingDetectIntentResponse>]
          #   An enumerable of Google::Cloud::Dialogflow::V2beta1::StreamingDetectIntentResponse instances.
          #
          # @raise [Google::Gax::GaxError] if the RPC is aborted.
          #
          # @note
          ...
          def streaming_detect_intent reqs, options: nil
            request_protos = reqs.lazy.map do |req|
              Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::StreamingDetectIntentRequest)
            end
