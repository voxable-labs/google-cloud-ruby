  ...
  module Cloud
    module Dialogflow
      module V2beta1
        ...
        #   @return [Google::Cloud::Dialogflow::V2beta1::Contexts::Stub]
        class ContextsClient
          ...
          def initialize \
            ...
            @contexts_stub = Google::Gax::Grpc.create_stub(
              ...
              scopes: scopes,
              &Google::Cloud::Dialogflow::V2beta1::Contexts::Stub.method(:new)
            )
          ...
          #   retries, etc.
          # @return [Google::Gax::PagedEnumerable<Google::Cloud::Dialogflow::V2beta1::Context>]
          #   An enumerable of Google::Cloud::Dialogflow::V2beta1::Context instances.
          ...
          #
          #   contexts_client = Google::Cloud::Dialogflow::V2beta1::Contexts.new
          #   formatted_parent = Google::Cloud::Dialogflow::V2beta1::ContextsClient.session_path("[PROJECT]", "[SESSION]")
          #
          ...
          def list_contexts \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::ListContextsRequest)
          ...
          #
          #   contexts_client = Google::Cloud::Dialogflow::V2beta1::Contexts.new
          #   formatted_name = Google::Cloud::Dialogflow::V2beta1::ContextsClient.context_path("[PROJECT]", "[SESSION]", "[CONTEXT]")
          ...
          def get_context \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::GetContextRequest)
          ...
          #   Note: Runtimes are under construction and will be available soon.
          #   If <Runtime ID> is not specified, we assume default 'sandbox' runtime.
          # @param context [Google::Cloud::Dialogflow::V2beta1::Context | Hash]
          #   Required. The context to create.
          #   A hash of the same form as `Google::Cloud::Dialogflow::V2beta1::Context`
          ...
          def create_context \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::CreateContextRequest)
          ...
          def update_context \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::UpdateContextRequest)
          ...
          def delete_context \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::DeleteContextRequest)
          ...
          def delete_all_contexts \
            ...
            req = Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::DeleteAllContextsRequest)
