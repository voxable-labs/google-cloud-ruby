...
describe Google::Cloud::Dialogflow::V2beta1::SessionsClient do

  describe 'detect_intent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionsClient#detect_intent."

    it 'invokes detect_intent without error' do
      # Create request parameters
      formatted_session = Google::Cloud::Dialogflow::V2beta1::SessionsClient.session_path("[PROJECT]", "[SESSION]")
      query_input = {}

      # Create expected grpc response
      response_id = "responseId1847552473"
      expected_response = { response_id: response_id }
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::DetectIntentResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::DetectIntentRequest, request)
        assert_equal(formatted_session, request.session)
        assert_equal(Google::Gax::to_proto(query_input, Google::Cloud::Dialogflow::V2beta1::QueryInput), request.query_input)
        expected_response
      end
      ...
      Google::Cloud::Dialogflow::V2beta1::Sessions::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::Credentials.stub(:default, mock_credentials) do
          client = Google::Cloud::Dialogflow::Sessions.new(version: :v2beta1)
  ...
  describe 'streaming_detect_intent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionsClient#streaming_detect_intent."
    ...
    it 'invokes streaming_detect_intent without error' do
      ...
      response_id = "responseId1847552473"
      expected_response = { response_id: response_id }
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::StreamingDetectIntentResponse)

      # Mock Grpc layer
      mock_method = proc do |requests|
        request = requests.first
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::StreamingDetectIntentRequest, request)
