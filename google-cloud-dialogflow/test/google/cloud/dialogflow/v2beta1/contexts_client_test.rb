...
describe Google::Cloud::Dialogflow::V2beta1::ContextsClient do
  ...
  describe 'list_contexts' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ContextsClient#list_contexts."
  ...
  describe 'get_context' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ContextsClient#get_context."
  ...
  describe 'create_context' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ContextsClient#create_context."
  ...
  describe 'update_context' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ContextsClient#update_context."
  ...
  describe 'delete_context' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ContextsClient#delete_context."
  ...
  describe 'delete_all_contexts' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::ContextsClient#delete_all_contexts."
