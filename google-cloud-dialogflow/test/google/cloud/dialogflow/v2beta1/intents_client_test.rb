...
describe Google::Cloud::Dialogflow::V2beta1::IntentsClient do

  describe 'list_intents' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#list_intents."

    it 'invokes list_intents without error' do
      # Create request parameters
      formatted_parent = Google::Cloud::Dialogflow::V2beta1::IntentsClient.project_agent_path("[PROJECT]")
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::ListIntentsResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::ListIntentsRequest, request)
      ...
      Google::Cloud::Dialogflow::V2beta1::Intents::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::Credentials.stub(:default, mock_credentials) do
          client = Google::Cloud::Dialogflow::Intents.new(version: :v2beta1)
  ...
  describe 'get_intent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#get_intent."

    it 'invokes get_intent without error' do
      # Create request parameters
      formatted_name = Google::Cloud::Dialogflow::V2beta1::IntentsClient.intent_path("[PROJECT]", "[INTENT]")
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::Intent)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::GetIntentRequest, request)
  ...
  describe 'create_intent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#create_intent."
    ...
    it 'invokes create_intent without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::CreateIntentRequest, request)
        assert_equal(formatted_parent, request.parent)
        assert_equal(Google::Gax::to_proto(intent, Google::Cloud::Dialogflow::V2beta1::Intent), request.intent)
        expected_response
      end
  ...
  describe 'update_intent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#update_intent."
    ...
    it 'invokes update_intent without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::UpdateIntentRequest, request)
        assert_equal(Google::Gax::to_proto(intent, Google::Cloud::Dialogflow::V2beta1::Intent), request.intent)
  ...
  describe 'delete_intent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#delete_intent."
    ...
    it 'invokes delete_intent without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::DeleteIntentRequest, request)
        assert_equal(formatted_name, request.name)
        nil
      end
  ...
  describe 'batch_update_intents' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#batch_update_intents."

    it 'invokes batch_update_intents without error' do
      # Create request parameters
      formatted_parent = Google::Cloud::Dialogflow::V2beta1::IntentsClient.agent_path("[PROJECT]", "[AGENT]")
      language_code = ''

      # Create expected grpc response
      expected_response = {}
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::BatchUpdateIntentsResponse)
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::BatchUpdateIntentsRequest, request)
        assert_equal(formatted_parent, request.parent)
        assert_equal(language_code, request.language_code)
        operation
      end
    ...
    it 'invokes batch_update_intents and returns an operation error.' do
      ...
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#batch_update_intents.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/batch_update_intents_test',
        done: true,
  ...
  describe 'batch_delete_intents' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#batch_delete_intents."

    it 'invokes batch_delete_intents without error' do
      # Create request parameters
      formatted_parent = Google::Cloud::Dialogflow::V2beta1::IntentsClient.project_path("[PROJECT]")
      intents = []
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::BatchDeleteIntentsRequest, request)
        assert_equal(formatted_parent, request.parent)
        intents = intents.map do |req|
          Google::Gax::to_proto(req, Google::Cloud::Dialogflow::V2beta1::Intent)
        end
    ...
    it 'invokes batch_delete_intents and returns an operation error.' do
      ...
      # Create expected grpc response
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dialogflow::V2beta1::IntentsClient#batch_delete_intents.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/batch_delete_intents_test',
        done: true,
