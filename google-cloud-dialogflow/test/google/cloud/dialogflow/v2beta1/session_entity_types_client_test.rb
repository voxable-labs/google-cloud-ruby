...
describe Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient do
  ...
  describe 'list_session_entity_types' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient#list_session_entity_types."
  ...
  describe 'get_session_entity_type' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient#get_session_entity_type."
  ...
  describe 'create_session_entity_type' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient#create_session_entity_type."
  ...
  describe 'update_session_entity_type' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient#update_session_entity_type."
  ...
  describe 'delete_session_entity_type' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::SessionEntityTypesClient#delete_session_entity_type."
