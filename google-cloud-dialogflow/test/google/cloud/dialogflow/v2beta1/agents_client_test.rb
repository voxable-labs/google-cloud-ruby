...
describe Google::Cloud::Dialogflow::V2beta1::AgentsClient do

  describe 'get_agent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#get_agent."

    it 'invokes get_agent without error' do
      # Create request parameters
      formatted_parent = Google::Cloud::Dialogflow::V2beta1::AgentsClient.project_path("[PROJECT]")
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::Agent)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::GetAgentRequest, request)
      ...
      Google::Cloud::Dialogflow::V2beta1::Agents::Stub.stub(:new, mock_stub) do
        Google::Cloud::Dialogflow::Credentials.stub(:default, mock_credentials) do
          client = Google::Cloud::Dialogflow::Agents.new(version: :v2beta1)
  ...
  describe 'search_agents' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#search_agents."
    ...
    it 'invokes search_agents without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::SearchAgentsResponse)

      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::SearchAgentsRequest, request)
        assert_equal(formatted_parent, request.parent)
        expected_response
      end
  ...
  describe 'train_agent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#train_agent."
    ...
    it 'invokes train_agent without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::TrainAgentRequest, request)
        assert_equal(formatted_parent, request.parent)
        operation
      end
    ...
    it 'invokes train_agent and returns an operation error.' do
      ...
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#train_agent.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/train_agent_test',
        done: true,
  ...
  describe 'export_agent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#export_agent."
    ...
    it 'invokes export_agent without error' do
      ...
      expected_response = Google::Gax::to_proto(expected_response, Google::Cloud::Dialogflow::V2beta1::ExportAgentResponse)
      result = Google::Protobuf::Any.new
      result.pack(expected_response)
      operation = Google::Longrunning::Operation.new(
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::ExportAgentRequest, request)
        assert_equal(formatted_parent, request.parent)
        operation
      end
    ...
    it 'invokes export_agent and returns an operation error.' do
      ...
      # Create expected grpc response
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#export_agent.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/export_agent_test',
        done: true,
  ...
  describe 'import_agent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#import_agent."
    ...
    it 'invokes import_agent without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::ImportAgentRequest, request)
        assert_equal(formatted_parent, request.parent)
        operation
      end
    ...
    it 'invokes import_agent and returns an operation error.' do
      ...
      # Create expected grpc response
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#import_agent.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/import_agent_test',
        done: true,
  ...
  describe 'restore_agent' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#restore_agent."
    ...
    it 'invokes restore_agent without error' do
      ...
      # Mock Grpc layer
      mock_method = proc do |request|
        assert_instance_of(Google::Cloud::Dialogflow::V2beta1::RestoreAgentRequest, request)
        assert_equal(formatted_parent, request.parent)
        operation
      end
    ...
    it 'invokes restore_agent and returns an operation error.' do
      ...
      # Create expected grpc response
      operation_error = Google::Rpc::Status.new(
        message: 'Operation error for Google::Cloud::Dialogflow::V2beta1::AgentsClient#restore_agent.'
      )
      operation = Google::Longrunning::Operation.new(
        name: 'operations/restore_agent_test',
        done: true,
